...
const ar: Record<string, string> = {
  ...
  "Search products, locations, categories...":
    "ابحث عن منتجات أو مواقع أو أقسام...",
  "Create listing": "أضف إعلانا",
  "Create Listing": "أضف إعلانا",
  ...
  "just for you": "مختار لك",
  "if you don't want to you don't have to":
    "إذا ما ودك تسحب، مو لازم",
  "you don't have to keep swipping move to the browse tap and search for what exactly you want":
    "مو لازم تستمر بالسحب. انتقل للتصفح وابحث عن الشيء الذي تريده بالضبط.",
  "Featured Deal": "عرض مميز",
  "we're just launched": "أطلقنا المنصة للتو",
  "so we may not have too many deals right now but you can go a head and start your own listing and show people what you have to offer":
    "قد لا توجد عروض كثيرة الآن، لكن بإمكانك إضافة إعلانك وعرض ما لديك للآخرين.",
  Featured: "المميز",
  ...
  "Failed to swipe": "تعذر تنفيذ السحب",
  ...
  "Only meet in public / crowded places for example metro stations and malls.":
    "قابل الطرف الآخر فقط في أماكن عامة ومزدحمة مثل المراكز التجارية والأماكن المعروفة.",
  "Never go alone to meet a buyer / seller, always take someone with you.":
    "لا تذهب وحدك لمقابلة بائع أو مشتر، واصطحب شخصا معك دائما.",
  ...
  "Never pay anything in advance or transfer money before inspecting the product.":
    "لا تدفع مقدما ولا تحول أي مبلغ قبل فحص المنتج.",
  ...
  "Manage your listing. Deleting will remove it from the marketplace.":
    "أدر إعلانك. الحذف سيزيله من المنصة.",
  Cancel: "إلغاء",
  "Deleting...": "جاري الحذف...",
  ...
  "Send the seller a message and speed up the process.":
    "أرسل رسالة للبائع لتسريع الإجراء.",
  ...
  "From value (EGP)": "من قيمة (ريال)",
  "To value (EGP)": "إلى قيمة (ريال)",
